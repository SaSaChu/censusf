$(function() {
    ...
    $("input[id='B067']").change(function() {
		if(this.checked) {
			...
			if(B061 && B062 || B062_2) {
				...
				alert('請確認聯絡人姓名、聯絡人手機或聯絡人電話是否填寫')
			}
		} else {
	...
	$("input[id='_340000']").change(function(){
		...
		let _030351 = $("select[id='_030351']").val()
		let _030353 = $("select[id='_030353']").val()
	...
	function checkFillInput(step) {
		...
		if(step === 0) {
			if($('#B062_2').val() == '' && $('#B062').val() == '') {
				notFill.push("B062_3");
			}

			if($('#B064_2').val() == '' && $('#B064').val() == '') {
				notFill.push("B064_3");
			}
		}
		...
		if(step === 5) {
			if($('#_050100:checked').val() == 1) {
				if($('#_050101').val() <= 0 || $('#_050101').val() > 12) {
					notFill.push("_050101");
				}
			}
			
			if($('#_050200:checked').val() == 1) {
				if($('#_050201').val() <= 0 || $('#_050201').val() > 12) {
					notFill.push("_050201");
				}
			}
		}
		...
		if(step === 62) {
			...
			let _060320 = $("input[id='_060320']:checked").val() 
			let _060330 = $("input[id='_060330']:checked").val()
			...
			if (_060300 === '1') {
				...
				if(_060320 == undefined) {
					notFill.push("_060320");
				}

				if(_060330 == undefined) {
					notFill.push("_060330");
				}
